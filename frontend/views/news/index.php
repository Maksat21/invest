            ...
            <div class="top-info">
                <div class="container">
                    ...
                    <div class="pull-right social">
                        <a href="index.html@page_id=24&amp;paged=1.html#" class="fab fa-facebook-f"></a>
                        <a href="index.html@page_id=24&amp;paged=1.html#" class="fab fa-twitter"></a>
                        <a href="index.html@page_id=24&amp;paged=1.html#" class="fab fa-google-plus-g"></a>
                        <a href="index.html@page_id=24&amp;paged=1.html#" class="fab fa-linkedin-in"></a>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="logo pull-left">
                    <a href="index.html"> <img src="wp-content/uploads/2018/12/logo2-1.png" alt="Awesome Image"> </a>
                </div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="collapse navbar-collapse main-navigation mainmenu " id="main-nav-bar">
                        <ul class="nav navbar-nav navigation-box  ">
                            <li id="menu-item-277" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children nav-item menu-item-277 dropdown submenu"><a title="Home" href="index.html">Home</a>
                                <ul role="menu" class="sub-menu">
                                    <li id="menu-item-543" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home nav-item menu-item-543"><a title="Home Page One" href="index.html">Home Page One</a></li>
                            ...
                            <li id="menu-item-292" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children nav-item menu-item-292 dropdown submenu"><a title="Pages" href="index.html@page_id=24&amp;paged=1.html#">Pages</a>
                                <ul role="menu" class="sub-menu">
                            ...
                            <li id="menu-item-298" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children nav-item menu-item-298 dropdown submenu active"><a title="Blog" href="index.html@page_id=24.html">Blog</a>
                                <ul role="menu" class="sub-menu">
                                    <li id="menu-item-299" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-24 current_page_item current_page_parent nav-item menu-item-299 active active"><a title="Blog Classic" href="index.html@page_id=24.html">Blog Classic</a></li>
