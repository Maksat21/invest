                        ...
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-d305867 elementor-column elementor-col-100 elementor-top-column" data-id="d305867" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-e9718f9 elementor-align-left elementor-widget elementor-widget-bdevs-team" data-id="e9718f9" data-element_type="widget" data-widget_type="bdevs-team.default">
                                                <div class="elementor-widget-container">
                                                    <section class="team-style-one sec-pad pb0">
                                                        <div class="container">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                                    <div class="single-team-style-one text-center">
                                                                        ...
                                                                        <div class="text-box">
                                                                            <p>Plumber</p>
                                                                            <div class="social">
                                                                                <a href="index.html#" class="fab fa-facebook-f"></a>
                                                                                <a href="index.html#" class="fab fa-twitter"></a>
                                                                                <a href="index.html#" class="fab fa-google-plus-g"></a>
                                                                ...
                                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                                    <div class="single-team-style-one text-center">
                                                                        <div class="img-box"> <img src="wp-content/uploads/2018/12/team-1-2.png" alt="Awesome Image" />
                                                                            <div class="name-box">
                                                                                <div class="inner">Latanya Julca</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-box">
                                                                            <p>Constractor</p>
                                                                ...
                                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                                    <div class="single-team-style-one text-center">
                                                                        <div class="img-box"> <img src="wp-content/uploads/2018/12/team-1-3.png" alt="Awesome Image" />
                                                                            <div class="name-box">
                                                                                <div class="inner">Aileen Metchikoff</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-box">
                                                                            <p>Founder &amp; CEO</p>
                                                                ...
                                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                                    <div class="single-team-style-one text-center">
                                                                        <div class="img-box"> <img src="wp-content/uploads/2018/12/team-1-4.png" alt="Awesome Image" />
                                                                            <div class="name-box">
                                                                                <div class="inner">Jordan Sisomphou</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-box">
                                                                            <p>Constractor</p>
